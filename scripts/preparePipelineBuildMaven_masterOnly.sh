...
mkdir -p ../jenkins_master_home/jobs/demo-pipeline-maven_masterOnly
...
cp ../files/master/demo-pipeline-maven_masterOnly/config.xml ../jenkins_master_home/jobs/demo-pipeline-maven_masterOnly
